<div class="painel">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "INSERT INTO rh (titulo, texto, path) VALUES ('$titulo', '$texto', '$path_arquivo')";
    ...
    ?>
        ...
        <div class="caixapainel">
            ...
            <div class="mini-painel">
                <strong><a href="?pagina=painel-rh"><img src="uploads/adicionar.png"></a></strong>
                <a href="?pagina=painel-editar-rh"><img src="uploads/editar.png"></a>
                <a href="?pagina=painel-deletar-rh"><img src="uploads/remover.png"></a>
            </div>
