...
<div class="painel">
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Query SQL corrigida
            $query = "UPDATE lc SET titulo = '$titulo', texto = '$texto' WHERE post = '$npost'";
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("input[name='post']").blur(function() {
                ...
                $.getJSON('function-edit-lc.php', { post: postValue }, function(json) {
    ...
    <div class="caixapainel">
        ...
        <div class="mini-painel">
            <a href="?pagina=painel-lc"><img src="uploads/adicionar.png" alt="Adicionar"></a>
            <strong><a href="?pagina=painel-editar-lc"><img src="uploads/editar.png" alt="Editar"></a></strong>
            <a href="?pagina=painel-deletar-lc"><img src="uploads/remover.png" alt="Remover"></a>
        </div>
