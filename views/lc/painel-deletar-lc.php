<div class="painel">
    ...
    <?php
        ...
        if(!empty($npost)) {
            if(mysqli_query($conexao, "DELETE FROM lc WHERE post = '$npost'")){
    ...
    <div class="caixapainel">
        ...
        <div class="mini-painel">
            <a href="?pagina=painel-lc"><img src="uploads/adicionar.png"></a>
            <a href="?pagina=painel-editar-lc"><img src="uploads/editar.png"></a>
            <strong><a href="?pagina=painel-deletar-lc"><img src="uploads/remover.png"></a></strong>
        </div>
